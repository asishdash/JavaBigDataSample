...
public class CustomersAndProducts {
	...
	public static void main(String[] args) {
		...
		String customers_file = "src/main/resources/file/customers.csv";
	    ...
	    String products_file = "src/main/resources/file/products.csv";
	    ...
	    String purchases_file = "src/main/resources/file/purchases.csv";
