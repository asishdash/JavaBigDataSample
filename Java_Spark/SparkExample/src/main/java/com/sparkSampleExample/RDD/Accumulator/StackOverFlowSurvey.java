package com.sparkSampleExample.RDD.Accumulator;
...
public class StackOverFlowSurvey {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaRDD<String> responseRDD = javaSparkContext.textFile("src/main/resources/file/2016-stack-overflow-survey-responses.csv");
