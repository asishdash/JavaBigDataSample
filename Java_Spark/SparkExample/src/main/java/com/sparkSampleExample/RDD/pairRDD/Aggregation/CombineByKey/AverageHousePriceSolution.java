package com.sparkSampleExample.RDD.pairRDD.Aggregation.CombineByKey;

import com.sparkSampleExample.RDD.pairRDD.Aggregation.ReduceByKey.housePrice.AvgCount;
...
public class AverageHousePriceSolution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaRDD<String> lines = sc.textFile("src/main/resources/file/RealEstate.csv");
