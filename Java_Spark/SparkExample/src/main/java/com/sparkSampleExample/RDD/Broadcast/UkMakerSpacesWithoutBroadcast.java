package com.sparkSampleExample.RDD.Broadcast;
...
public class UkMakerSpacesWithoutBroadcast {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaRDD<String> makerSpaceRdd = javaSparkContext.textFile("src/main/resources/file/uk-makerspaces-identifiable-data.csv");
    ...
    private static Map<String, String> loadPostCodeMap() throws FileNotFoundException {
        Scanner postCode = new Scanner(new File("src/main/resources/file/uk-postcode.csv"));
